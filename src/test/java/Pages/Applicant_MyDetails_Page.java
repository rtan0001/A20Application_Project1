...
public class Applicant_MyDetails_Page extends BaseUtil{

    public static Set<String> windows ;

    public Applicant_MyDetails_Page(WebDriver driver)
    {
        this.driver = driver;
...
//    }
    ...
    public void  Select_Location(String  Location) throws InterruptedException {
        ...
        WebElement list_items =  driver.findElement(By.xpath("//*[@class='slds-form--stacked']/div[18]/div[1]/div/div/div/div/select"));
    ...
    public void  Select_CitizenShip(String  CitizenShip) throws InterruptedException {
        ...
        WebElement list_items = driver.findElement(By.xpath("//*[@class='slds-form--stacked']/div[19]/div[1]/div[1]/div[1]/div[1]/div/div/select"));
    ...
    public void  Select_Disability(String Disability) throws InterruptedException {

        Thread.sleep(1000);

        WebElement list_items = driver.findElement(By.xpath("//*[@id='AccessAndEquityDomesticDivId']/div/div[2]/div[3]/label/span"));

        if(list_items.getText().equals(Disability))
    ...
    public void  Click_SaveButton() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id='ServiceCommunityTemplate']/div[2]/div/div[2]/div/div/div/div/div[2]/div/div/form/div[27]/center/div/button[1]")).click();
        Thread.sleep(4000);
    }
